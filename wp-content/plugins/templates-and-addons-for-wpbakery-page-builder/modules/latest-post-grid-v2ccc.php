<?php
vc_map(array(
    "name" 			=> "Latest Post Grid v22",
    "category" 		=> 'Templates & Addons',
    "description"	=> "",
    "base" 			=> "tavc_latest_post_grid_v22",
    "class" 		=> "",
    "icon" 			=> "tavc_icon",
...
function tavc_latest_post_grid_v2_shortcode2($atts, $content = null) {
...
add_shortcode("tavc_latest_post_grid_v22", "tavc_latest_post_grid_v2_shortcode2");